...
class meta_ERCSR(nn.Module):
   def __init__(self, n_colors=102,n_feats=64,n_E_HCM=4, n_twoUint=2,upmode = 'Meta_upsample', experts = 4):
       super().__init__()
       ...
       self.up = { 'bandAttn_Meta_upsample':bandAttn_Meta_upsample,\
